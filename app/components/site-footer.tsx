...
export function SiteFooter() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-plum/10 bg-pink-soft text-plum">
      ...
      <div className="relative border-t border-plum/10 bg-cream/80 px-6 py-5 text-[11px] leading-relaxed tracking-wide text-muted lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-3">
          ...
          <p className="max-w-4xl text-[10px] leading-relaxed text-muted/90 sm:mx-auto sm:text-center">
            {companyDisclaimer}
          </p>
        </div>
      </div>
